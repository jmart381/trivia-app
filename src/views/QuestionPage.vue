...
//handle answer choice and award points
const handleAnswers = (points) => {
  changeScore(points)
...
<div v-html="question.question" class="text-center text-2xl font-bold"></div>
  ...
  v-html="answer.answer"
    :key="answer.id"
    @click="handleAnswers(answer.points)"
    class="bg-green-500 flex items-center justify-center text-4xl rounded-lg text-white py-8 px-2">
    </div>
  </div>
